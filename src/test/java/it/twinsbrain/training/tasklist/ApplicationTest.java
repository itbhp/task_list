...
public final class ApplicationTest {
  ...
  public ApplicationTest() throws IOException {
    var in = new BufferedReader(new InputStreamReader(new PipedInputStream(inStream)));
    var out = new PrintWriter(new PipedOutputStream(outStream), true);
    var taskList = new TaskList(in, out);
